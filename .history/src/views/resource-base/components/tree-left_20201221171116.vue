...
export default {
  setup() {
    ...
    const upTreeData = (params)=>{
      
    //  let res:any =  axios.post('/tiku/bookVersion/queryVresionBookTree',params)
     console.log(  axios.post('/tiku/bookVersion/queryVresionBookTree',params));
    }
