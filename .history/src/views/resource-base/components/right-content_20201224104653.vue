    ...
    <ul class="tableMain">
      <li v-for="(item, index) in tableData" :key="index" @mouseleave="mouseleaveisShow(item)">
        ...
        <div class="changeTdOperation" v-show="item.isShow" @mouseleave="mouseleaveisShow(item)">
          <span @click="renameDialog=true">重命名</span>
          <span>移动</span>
          <span>下载</span>
      ...
      <el-dialog title="重命名" :visible="renameDialog" >
...
export default {
  ...
  getRightContent()
    ...
    return { tableData, mouseleaveisShow,changeTdOperation,deleteClick,aNewName,renameDialog };
  },
};
</script>
