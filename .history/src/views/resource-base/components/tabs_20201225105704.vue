...
export default {
  ...
  let pageParam: any = {
    ...
    ext: null,
    fileName: "",
    courseId: "1ba722053365491cae02185b3c470a6f",
    subject: "chinese3",
    type:2
  };
  ...
  const getMaterialQueryPage = (item)=>{
    ...
    //  params.type = item.Type
     axios.post<any,AxResponse>(`admin/material/queryPage?size=${20}&current=${1}`,  pageParam, { headers: { "Content-Type": "application/json", type: "1" } }).then(res=>{
       if(res.result){
         console.log(res);
       }
     })
