...
export default {
  setup() {
    ...
    axios.post<any, AxResponse>(`admin/material/queryPage?size=${20}&current=${1}`,params,{headers: { "Content-Type": "application/json", type: "1",}})
      .then((res) => {
  ...
  .tableMain {
    ...
    > li {
      ...
      .imageOperation {
        ...
        width: 16px;
        height: 16px;
        background-color: url("../../assets/images/icon_d44l6421sgu/caozuo.png")
          no-repeat center;
      }
