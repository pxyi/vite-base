              ...
              <ul>
                <li v-for="item in courseDatials" :key="item">
                    <div class="near-list-left" >  
                     ...
                     <div class="menu">
                      <el-button  size="small" v-if="item.lessonStatus == 1" plain @click="courseDetailFileList(item,index)">继续备课</el-button>
                      <!-- <el-button size="small" :class=" (item.lessonStatus) === 1?'':''" @click.stop="SubCourse(item)" >提交备课1</el-button> -->
                      <el-button size="small" v-if="item.lessonStatus == 2" disabled @click.stop="SubCourse(item)" >已备课</el-button>
                    </div>
                </li>  
              </ul>
          </div>
    ...
    ul{
        li{
            ...
            .menu{
              ...
              .el-button{
                width: 86px;
                border: 1px solid $borderHoverColor !important;
