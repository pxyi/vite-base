         ...
         <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          ...
          <template #label>
            ...
            <div class="btn-box">
              ...
              <el-button type="primary" round @click="uploadMyPlan(item)">上传我的说课</el-button>
            </div>
...
import PrepareUpload from './prepare-upload.vue'
...
export default {
  ...
  setup(props) {
    ...
    // 上传我的教案
    const uploadMyPlan = () => {
      Modal.create({ title: '上传我的教案', width: 640, component: PrepareUpload, props: { id: props.id }, zIndex: 999 }).then(resolve => {
        request('');
        console.log(tabCountRequest(),111)
        
      })
    }

    return { close, activeName, tabCountList, courseDto, request, allFileList, handleClick, prepareLesson, uploadMyPlan, prepareLessonRequest, tabCountRequest }
  }
}
</script>
