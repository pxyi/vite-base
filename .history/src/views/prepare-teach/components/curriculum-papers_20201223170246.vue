        ...
        <div class="class-top">
          ...
          <div class="class-list">
            <div>
              ...
              <p><span class="span-title">课程类型：</span><span class="span-content">{{ courseDto.subjectName ||'无' }}</span></p>
            </div>
            <div>
              <p class="front"><span class="span-title">年级：</span><span class="span-content">{{ courseDto.subjectName ||'无' }}</span></p>
              <p><span class="span-title">保存时间：</span><span class="span-content">{{ courseDto.subjectName ||'无' }}</span></p>
            </div>
          </div>       
        </div>
      </div>
...
export default {
  ...
  setup(props) {
    ...
    return { close, activeName, tabCountList }
  }
}
</script>
