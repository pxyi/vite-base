  ...
  <div class="paper__update__container">
    <div class="header">
      ...
      <div class="btns">
        ...
        <el-button round @click="savePrepareClass" :disabled="prepareLesson == '' && prepareLesson.id == null " v-if="prepareLesson.checkStatus == 0">提交备课</el-button>
...
export default {
  ...
  setup(props) {
    ...
    axios.post<any,AxResponse>(
      ...
      { courseIndexId: props.id}).then( res => {
        if(res.result){
          ...
          res.json.prepareLesson ? prepareLesson.value = res.json.prepareLesson : { checkStatus: 0 };
          console.log(prepareLesson)
        }
      })
    ...
    let tabCountList = ref([
      ...
      { name: '讲义', nameKey: 'handoutCount', num: 0, type: 2, id: 2 }, 
      { name: '标准教案', nameKey: 'teachplanCount', num: 0, type: 5, id: 3 }, 
      { name: '说课视频', nameKey: 'mediaCount', num: 0, type: 3, id: 4 },
      { name: '其他', nameKey: 'otherCount', num: 0, type: 4, id: 5 },
    ])
    axios.post<any,AxResponse>(
    ...
    return { close, activeName, tabCountList, courseDto, request, allFileList, handleClick, prepareLesson }
  }
}
</script>
