...
export default {
  ...
  setup(props) {
    ...
    return { 
      close, activeName, tabCountList, courseDto, request, allFileList, handleClick, prepareLesson, uploadMyPlan, tabCountRequest, uploadMyVideo, savePrepareClass, type
    }
  }
}
</script>
