<template>
  <div class="prepare__list__container" v-loading="loading">
    <div class="prepare__list__main">
      <div class="prepare__list__item" v-for="(node) in list" :key="node.id">
        <div class="prepare__list__avatar"><slot name="avatar" /></div>
        <div class="prepare__list__content"><slot :data="node" /></div>
        <div class="prepare__list__actions"><slot name="actions" :data="node" /></div>
      </div>
    </div>
...
.prepare__list__container {
  ...
  .prepare__list__item {
    ...
    .prepare__list__content {
      flex: auto;
    }
    .prepare__list__actions {
      display: flex;
      margin-left: auto;
    }
  }
