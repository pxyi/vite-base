...
export default {
  ...
  setup(props) {
    ...
    // 上传我的教案
    const uploadMyPlan = () => {
      Modal.create({ title: '上传我的教案', width: 640, component: PrepareUpload, props: { id: props.id }, zIndex: 999 })
    }

    // 上传我的说课
    const uploadMyVideo = () => {
      Modal.create({ title: '上传我的说课', width: 640, component: PrepareUpload, props: { id: props.id }, zIndex: 999 })
    }
