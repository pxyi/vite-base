...
export default {
  ...
  setup(props) {
    ...
    return { close, activeName, tabCountList, courseDto, request, allFileList, handleClick, prepareLesson, uploadMyPlan, prepareLessonRequest, tabCountRequest, uploadMyVideo, savePrepareClass }
  }
}
</script>
