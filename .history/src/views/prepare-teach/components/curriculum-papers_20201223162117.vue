...
export default {
  ...
  setup(props) {
    ...
    let tabCountList = ref([
      { name: '全部', nameKey: 'totalCount' }, 
      { name: '课件', nameKey: 'courseWareCount' }, 
      { name: '讲义', nameKey: 'handoutCount' }, 
      { name: '标准教案', nameKey: 'teachplanCount' }, 
      { name: '说课视频', nameKey: 'otherCount' },
      { name: '其他', nameKey: 'totalCount' },
      ])
