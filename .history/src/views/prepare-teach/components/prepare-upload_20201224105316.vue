...
export default ({
  ...
  setup( props ) {
    ...
    //     type: 5,
    //   };
    //   let res = await axios.post<any, AxResponse>('/admin/material/saveUserMaterial', __params, { headers: { type: 1, 'Content-Type': 'application/json' }});
    // }
    let formRef = ref()
    ...
    return { uploadAction, newFileList, fileList, handleChange, save  }
  }
