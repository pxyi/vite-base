<template>
  <div class="paper__update__container">
    <div class="header">
      ...
      <div class="btns">
        <el-button round @click="save" :disabled="prepareLesson === '' && prepareLesson.id === null " v-if="!prepareLesson.checkStatus || prepareLesson.checkStatus === 0">提交备课</el-button>
        <el-button round @click="save" v-if="prepareLesson.checkStatus === 1"  >已提交</el-button>
...
export default {
  ...
  setup(props) {
    ...
    return { 
      ...
      prepareLessonRequest, tabCountRequest, uploadMyVideo, save, type
    }
  }
}
</script>
