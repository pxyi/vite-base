...
export default ({
  ...
  setup( props, { emit } ) {
    ...
    const save = (resolve, reject) => {
      ...
      let res =  axios.post<any, AxResponse>('/admin/material/saveUserMaterial', __params).then(res => {
        if(res.result) {
          resolve();
        }
      })
    ...
    return { uploadAction, newFileList, fileList, save, ercodeType, urlType, ercodeClick, urlClick, ercodeOrUrl, uploadUrlData  }
  }
