  ...
  <div class="paper__update__container">
    <div class="header">
      ...
      <div class="btns">
        ...
        <el-button round @click="savePrepareClass" :disabled="prepareLesson == '' && prepareLesson.id == null " v-if="courseDto.checkStatus == 0">提交备课</el-button>
        <el-button round v-if="courseDto.checkStatus == 1" disabled>已提交</el-button>
        <el-button round v-if="courseDto.checkStatus == 2" disabled>已备课</el-button>
      </div>
    </div>
    <div class="content">
