<template>
  <div class="cus__query__class__container">
    ...
    <div class="cus__class__item">
      ...
      <div class="cus__class__box">
        <div class="cus__class__cell" v-for="cell in searchRules.courseTypes" :key="cell.id" @click="setQueryValue('terms', cell.id)" :class="{ active: cell.id === queryForm.courseTypes }">{{ cell.name }}</div>
      </div>
    </div>
  </div>
</template>
