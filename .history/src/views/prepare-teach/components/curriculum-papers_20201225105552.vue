      ...
      <div class="main">
         <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          ...
          <template #label>
            ...
            <div class="btn-box" v-if="prepareLesson.checkStatus !== 2">
...
export default {
  ...
  setup(props) {
    ...
    // 上传我的说课
    const uploadMyVideo = () => {
      Modal.create({ title: '上传我的说课', width: 640, component: MyVideoUpload, props: { id: props.id }, zIndex: 999 }).then(resolve => {
