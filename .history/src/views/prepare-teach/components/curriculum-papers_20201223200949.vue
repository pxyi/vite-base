      ...
      <div class="main">
         <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          ...
          <template #label>
            ...
            <div class="btn-box">
              <el-button type="primary" round @click="uploadMyPlan">上传我的教案</el-button>
...
export default {
  ...
  setup(props) {
    ...
    // 上传我的教案
    const uploadMyPlan = () => {
      Modal.create({ title: '上传我的教案', width: 640, component: PrepareUpload, props: { },zIndex: 999, })
    }

    return { close, activeName, tabCountList, courseDto, request, allFileList, handleClick, prepareLesson, uploadMyPlan }
  }
}
</script>
