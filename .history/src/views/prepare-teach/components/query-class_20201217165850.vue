<template>
  <div class="cus__query__class__container">
    ...
    <div class="cus__class__item">
      <div class="cus__class__label">来源</div>
      <div class="cus__class__box">
        <div class="cus__class__cell" v-for="cell in searchRules.sources" :key="cell.id" @click="setQueryValue('source', cell.id)" :class="{ active: cell.id === queryForm.source }">{{ cell.name }}</div>
      </div>
    </div>
  </div>
</template>
