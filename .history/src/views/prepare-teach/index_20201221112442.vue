  ...
  export default {
    ...
    setup(props,{ emit }) {
      ...
      const request = async (params?) => {
        ...
        await axios({
          method:"post",
          url:"/course/queryByPage",
          data:{...params, current: page.current, size: page.size },
        ...
        let res = await axios.post<any>('/course/queryByPage',{ ...params, current: page.current, size: page.size, },{ headers: {type: 1, 'Content-Type': 'application/json'}});
