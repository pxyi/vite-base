  ...
  <div>
    ...
    <div>
      ...
      <div  v-if="params.value == 0">
          <PrepareListComponent ref="list" has-page url="/tiku/paper/queryPaperPage" :default="params" :auto-request="false">
...
<script lang='ts'>
  ...
  import PrepareListComponent from './components/prepare-list.vue';
...
//   import Modal from './../../utils/modal';
  ...
  export default {
    components: { HeaderRefComponent, QueryClassComponent, PrepareListComponent },
