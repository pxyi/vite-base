...
export default {
  ...
  setup(props) {
    ...
    const prepareLessonRequest = new Promise(id,function(resolve, reject) {
        axios.post<any,AxResponse>('/admin/prepareLesson/queryPrepareLessonByCourseIndexId',{ id: id }).then(res => {
    ...
    //   // }
    // }
    return { params, courseDetailFileList, prepareLessonRequest, nearList }
  }
}
</script>
