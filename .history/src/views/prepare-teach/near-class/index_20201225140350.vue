    ...
    <cus-list has-page url="/admin/prepareLesson/queryPageV2" :default="params" :auto-request="true" :headers='{ type: 1 }' ref="nearList">
      ...
      <template v-slot:actions="{ data }">
        <div class="menu">
          ...
          <el-button size="small" round :class="'btn-hidden'"  @click="savePrepareClass(data)">提交备课</el-button>
...
export default {
  ...
  setup(props) {
    ...
    const courseDetailFileList = (item) => {
      ...
      Screen.create( CurriculumPapers, { title: item.courseName, id: id }).then(res => {
        console.log(res)
      })
    }
    ...
    //   // }
    // }
    return { params, courseDetailFileList, prepareLessonRequest }
  }
}
</script>
