  ...
  export default {
    ...
    setup(props,{ emit }) {
      ...
      const request = async (params?) => {
        ...
        // loading.value = true;
        let res = await axios.post<any, AxResponse>('/course/queryByPage', { year: "156605d9bbba424698a5e887ae2ed471", current: page.current, size: page.size, selectId: 'chinese3'  });
        // if (res.result) {
