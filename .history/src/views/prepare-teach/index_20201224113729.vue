<template>
  ...
  <div>
    <QueryClassComponent @query="$ref.list.request($event)" :searchShow='listShow'/>
    <div>
      <div class="cus-list clearfix" v-if="listShow == 1">
        <cus-list ref="list" has-page url="/course/queryByPage" :default="params" :auto-request="false" >
