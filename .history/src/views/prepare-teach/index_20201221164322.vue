  ...
  export default {
    ...
    setup(props,{ emit }) {
      ...
      let nearParams = {
        ...
        let res = axios.post<any,AxResponse>('/admin/prepareLesson/queryPage',{...nearParams, current: page.current, size: page.size, selectId: selectId},{ headers: { type: 1, 'Content-Type': 'application/json'}})
            .then(res =>{
                if (res.result) {
                    page.total = res.json.total;
