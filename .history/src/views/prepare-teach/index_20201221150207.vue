              ...
              <ul>
                <li v-for="item in courseDatials" :key="item">
                    <div class="near-list-left" >  
                        ...
                        <el-tooltip class="item" effect="dark" :content="item.courseIndexName" placement="bottom" :disabled='$refs.session.style.width <= "40%"'>
                            <div class="session" ref="session">{{item.courseIndexName}}</div>
                        </el-tooltip>
