  ...
  <div>
    ...
    <div>
      ...
      <div  v-if="params.value == 0">
          <div class="near-list">
              <div class="near-list-column">
                  <img src="/@/assets/prepare-teach/book_logo.png" width="16" height="16" alt="">
              </div>
          </div>
           <!-- <prepare-list ref="list" has-page url="/tiku/paper/queryPaperPage" :default="params" :auto-request="false">
...
<script lang='ts'>
  ...
  export default {
    components: { HeaderRefComponent, QueryClassComponent, PrepareList },
    ...
    setup(props,{ emit }) {
      ...
      return { headerRef, params, request, loading, courseList }
    }
  }
</script>
