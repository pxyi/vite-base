<template>
  <template ref="headerRef">
    <HeaderRefComponent @type-change="params.value = $event" @search="params.title = $event" :searchShow='params.value = $event' />
  </template>
  <div>
    <QueryClassComponent @query="request($event)" :searchShow='params.value = $event'/>
    <div>
